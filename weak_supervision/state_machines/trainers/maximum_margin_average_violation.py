...
class MaverTrainer(DynamicMaximumMarginalLikelihood):
    """
    Implementation of MAVER from Misra et al. 2018 (https://arxiv.org/pdf/1809.01299.pdf)
    """
    def __init__(self,
                 beam_size: int,
    ...
    def process(self,
        ...
        for instance_states in states_by_batch_index.values():
            ...
            loss += torch.sum(all_constraints) / len(instance_states)
